...
//               >
//                 <img
//                   src={`https://groceryapp-backend-552v.onrender.com/images/${img}`}
//                   alt=""
...
//             <img
//               src={`https://groceryapp-backend-552v.onrender.com/images/${thumbnail}`}
//               alt="product"
...
const SingleProduct = () => {
  const { products, navigate, addToCart, cartItems, axios } = useAppContext();
  const { id } = useParams();
  ...
  // ---------------- Sync cart to backend whenever cartItems changes ----------------
  useEffect(() => {
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-16">
        ...
        <div className="w-full md:w-1/2 text-sm">
          ...
          <div className="mt-6">
            ...
            <p className="text-xl sm:text-2xl font-medium">₹{product.offerPrice}</p>
